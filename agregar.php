    ...
    <h1 class="display-4 text-center">Cine <small class="text-primary">'GRAN ODEÓN'</small></h1>
        ...
        <div class="container-fluid row">
            <form class="col-4 p-3 m-auto" method="POST">
                <h3 class="text-center text-secondary">Registro de Película</h3>
                <?php
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="protagonista">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Rol Secundario</label>
                    <input type="text" class="form-control" name="secundario">
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary" name="insertar" value="ok">Agregar</button>
            </form>
        </div>
